...
fn main() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(959f32),
                height: pi_flex_layout::prelude::Dimension::Points(1373f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 959f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 1373f32);
