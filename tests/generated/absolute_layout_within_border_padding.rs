...
#[test]
fn absolute_layout_within_border_padding() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            position: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Points(0f32),
                top: pi_flex_layout::prelude::Dimension::Points(0f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            position: pi_flex_layout::prelude::Rect {
                right: pi_flex_layout::prelude::Dimension::Points(0f32),
                bottom: pi_flex_layout::prelude::Dimension::Points(0f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 50f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 50f32);
    assert_eq!(layout.rect.left.round(), 20f32);
