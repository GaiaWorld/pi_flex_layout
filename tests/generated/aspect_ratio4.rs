...
fn aspect_ratio4() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(220f32),
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            flex_grow: 1f32,
            flex_basis: pi_flex_layout::prelude::Dimension::Points(150f32),
            aspect_ratio: pi_flex_layout::prelude::Number::Defined(2.1111112f32),
            ..Default::default()
        },
    );
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 220f32);
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 220f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 124f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 11f32);
    let layout = layout_tree.get_layout(node_4).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 220f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 104f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    ...
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 104f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 284f32);
}
