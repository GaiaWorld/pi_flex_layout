...
fn gap6() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            row_gap: pi_flex_layout::prelude::Dimension::Points(0f32),
            column_gap: pi_flex_layout::prelude::Dimension::Points(0f32),
            ..Default::default()
        },
    );
    ...
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 75f32);
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 100f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 50f32);
    assert_eq!(layout.rect.left.round(), 200f32);
    assert_eq!(layout.rect.top.round(), 75f32);
