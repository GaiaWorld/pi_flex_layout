...
fn percentage_width_height() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Percent(0.3f32),
                height: pi_flex_layout::prelude::Dimension::Percent(0.3f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 120f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 0f32);
}
