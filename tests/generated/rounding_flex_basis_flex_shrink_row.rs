...
fn rounding_flex_basis_flex_shrink_row() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(101f32),
    ...
    layout_tree.insert(
        ...
        pi_slotmap_tree::InsertType::Back,
        pi_flex_layout::prelude::Style {
            flex_basis: pi_flex_layout::prelude::Dimension::Points(25f32),
            ..Default::default()
        },
    );
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 101f32);
