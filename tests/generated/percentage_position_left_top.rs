...
fn percentage_position_left_top() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                ...
                height: pi_flex_layout::prelude::Dimension::Percent(0.55f32),
                ..Default::default()
            },
            position: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Percent(0.1f32),
                top: pi_flex_layout::prelude::Dimension::Percent(0.2f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 180f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 220f32);
