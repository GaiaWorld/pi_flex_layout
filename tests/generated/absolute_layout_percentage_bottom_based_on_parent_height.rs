...
fn absolute_layout_percentage_bottom_based_on_parent_height() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            position_type: pi_flex_layout::prelude::PositionType::Absolute,
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(10f32),
                height: pi_flex_layout::prelude::Dimension::Points(10f32),
                ..Default::default()
            },
            position: pi_flex_layout::prelude::Rect {
                top: pi_flex_layout::prelude::Dimension::Percent(0.5f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            position: pi_flex_layout::prelude::Rect {
                bottom: pi_flex_layout::prelude::Dimension::Percent(0.5f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            position: pi_flex_layout::prelude::Rect {
                top: pi_flex_layout::prelude::Dimension::Percent(0.1f32),
