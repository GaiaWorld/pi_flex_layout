...
fn test1() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(250f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            size: pi_flex_layout::prelude::Size {
                height: pi_flex_layout::prelude::Dimension::Points(40f32),
                ..Default::default()
            },
            min_size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(80f32),
                ..Default::default()
            },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            flex_grow: 1f32,
            flex_shrink: 1f32,
            flex_basis: pi_flex_layout::prelude::Dimension::Points(100f32),
            size: pi_flex_layout::prelude::Size {
                height: pi_flex_layout::prelude::Dimension::Points(40f32),
                ..Default::default()
            },
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 250f32);
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 120f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 40f32);
    assert_eq!(layout.rect.left.round(), 120f32);
    assert_eq!(layout.rect.top.round(), 40f32);
}
