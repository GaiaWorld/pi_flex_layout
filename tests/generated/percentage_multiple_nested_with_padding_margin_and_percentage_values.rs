...
fn percentage_multiple_nested_with_padding_margin_and_percentage_values() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            flex_direction: pi_flex_layout::prelude::FlexDirection::Column,
            flex_grow: 1f32,
            flex_basis: pi_flex_layout::prelude::Dimension::Percent(0.1f32),
            min_size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Percent(0.6f32),
                ..Default::default()
            },
            margin: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Points(5f32),
                right: pi_flex_layout::prelude::Dimension::Points(5f32),
                top: pi_flex_layout::prelude::Dimension::Points(5f32),
                bottom: pi_flex_layout::prelude::Dimension::Points(5f32),
                ..Default::default()
            },
            padding: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Points(3f32),
                right: pi_flex_layout::prelude::Dimension::Points(3f32),
                top: pi_flex_layout::prelude::Dimension::Points(3f32),
                bottom: pi_flex_layout::prelude::Dimension::Points(3f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            flex_direction: pi_flex_layout::prelude::FlexDirection::Column,
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Percent(0.5f32),
                ..Default::default()
            },
            margin: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Points(5f32),
            ...
            padding: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Percent(0.03f32),
                right: pi_flex_layout::prelude::Dimension::Percent(0.03f32),
                top: pi_flex_layout::prelude::Dimension::Percent(0.03f32),
                bottom: pi_flex_layout::prelude::Dimension::Percent(0.03f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Percent(0.45f32),
                ..Default::default()
            },
            margin: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Percent(0.05f32),
                right: pi_flex_layout::prelude::Dimension::Percent(0.05f32),
                top: pi_flex_layout::prelude::Dimension::Percent(0.05f32),
                bottom: pi_flex_layout::prelude::Dimension::Percent(0.05f32),
                ..Default::default()
            },
            padding: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Points(3f32),
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            flex_grow: 4f32,
            flex_basis: pi_flex_layout::prelude::Dimension::Percent(0.15f32),
            min_size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Percent(0.2f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 48f32);
    assert_eq!(layout.rect.left.round(), 5f32);
    assert_eq!(layout.rect.top.round(), 5f32);
    let layout = layout_tree.get_layout(node_4).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 57f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 18f32);
    assert_eq!(layout.rect.left.round(), 8f32);
    assert_eq!(layout.rect.top.round(), 8f32);
    let layout = layout_tree.get_layout(node_5).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 23f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 6f32);
    assert_eq!(layout.rect.left.round(), 6f32);
    assert_eq!(layout.rect.top.round(), 6f32);
    let layout = layout_tree.get_layout(node_6).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 40f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 142f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 58f32);
}
