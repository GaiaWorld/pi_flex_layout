...
fn justify_content_min_width_with_padding_child_width_greater_than_parent() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(1000f32),
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 1000f32);
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 500f32);
