...
fn test3() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            flex_grow: 1f32,
            flex_shrink: 1f32,
            flex_basis: pi_flex_layout::prelude::Dimension::Auto,
            size: pi_flex_layout::prelude::Size {
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 83f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 40f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 0f32);
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 83f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 40f32);
    assert_eq!(layout.rect.left.round(), 83f32);
    assert_eq!(layout.rect.top.round(), 0f32);
    let layout = layout_tree.get_layout(node_5).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 83f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 40f32);
    assert_eq!(layout.rect.left.round(), 167f32);
    assert_eq!(layout.rect.top.round(), 0f32);
}
