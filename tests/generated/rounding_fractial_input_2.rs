...
fn rounding_fractial_input_2() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            size: pi_flex_layout::prelude::Size {
                ...
                height: pi_flex_layout::prelude::Dimension::Points(113.6f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 114f32);
    ...
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 65f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 0f32);
    let layout = layout_tree.get_layout(node_4).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 0f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 25f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 65f32);
