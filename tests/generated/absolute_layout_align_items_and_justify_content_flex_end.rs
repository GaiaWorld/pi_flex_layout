...
fn absolute_layout_align_items_and_justify_content_flex_end() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            justify_content: pi_flex_layout::prelude::JustifyContent::FlexEnd,
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(110f32),
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 110f32);
