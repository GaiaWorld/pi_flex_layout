...
fn wrap_reverse_column() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(30f32),
                height: pi_flex_layout::prelude::Dimension::Points(31f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(30f32),
                height: pi_flex_layout::prelude::Dimension::Points(32f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(30f32),
                height: pi_flex_layout::prelude::Dimension::Points(33f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(30f32),
                height: pi_flex_layout::prelude::Dimension::Points(34f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 31f32);
    assert_eq!(layout.rect.left.round(), 50f32);
    assert_eq!(layout.rect.top.round(), 0f32);
    let layout = layout_tree.get_layout(node_4).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 30f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 32f32);
    assert_eq!(layout.rect.left.round(), 50f32);
    assert_eq!(layout.rect.top.round(), 31f32);
    let layout = layout_tree.get_layout(node_5).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 30f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 33f32);
    assert_eq!(layout.rect.left.round(), 50f32);
    assert_eq!(layout.rect.top.round(), 63f32);
    let layout = layout_tree.get_layout(node_6).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 30f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 34f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 0f32);
}
