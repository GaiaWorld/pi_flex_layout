...
fn justify_content_min_width_with_padding_child_width_lower_than_parent() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            align_content: pi_flex_layout::prelude::AlignContent::Stretch,
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(1080f32),
                height: pi_flex_layout::prelude::Dimension::Points(1584f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            padding: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Points(100f32),
                right: pi_flex_layout::prelude::Dimension::Points(100f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            align_content: pi_flex_layout::prelude::AlignContent::Stretch,
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(199f32),
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 1080f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 1584f32);
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 199f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 100f32);
    assert_eq!(layout.rect.left.round(), 101f32);
    assert_eq!(layout.rect.top.round(), 0f32);
}
