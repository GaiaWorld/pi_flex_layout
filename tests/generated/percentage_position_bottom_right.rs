...
fn percentage_position_bottom_right() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(500f32),
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Percent(0.55f32),
                height: pi_flex_layout::prelude::Dimension::Percent(0.15f32),
                ..Default::default()
            },
            position: pi_flex_layout::prelude::Rect {
                right: pi_flex_layout::prelude::Dimension::Percent(0.2f32),
                bottom: pi_flex_layout::prelude::Dimension::Percent(0.1f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 275f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 75f32);
    assert_eq!(layout.rect.left.round(), -100f32);
    assert_eq!(layout.rect.top.round(), -50f32);
}
