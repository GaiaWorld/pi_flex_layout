...
fn percentage_flex_basis() {
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 125f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 0f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 0f32);
    let layout = layout_tree.get_layout(node_4).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 75f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 0f32);
    assert_eq!(layout.rect.left.round(), 125f32);
    assert_eq!(layout.rect.top.round(), 0f32);
}
