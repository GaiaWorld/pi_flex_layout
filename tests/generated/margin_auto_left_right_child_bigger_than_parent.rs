...
fn margin_auto_left_right_child_bigger_than_parent() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(52f32),
                height: pi_flex_layout::prelude::Dimension::Points(52f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(72f32),
                height: pi_flex_layout::prelude::Dimension::Points(72f32),
                ..Default::default()
            },
            margin: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Auto,
                right: pi_flex_layout::prelude::Dimension::Auto,
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 52f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 52f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 0f32);
    let layout = layout_tree.get_layout(node_3).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 72f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 72f32);
