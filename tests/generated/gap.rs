...
fn gap() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            row_gap: pi_flex_layout::prelude::Dimension::Percent(0.1f32),
            column_gap: pi_flex_layout::prelude::Dimension::Percent(0.1f32),
            ..Default::default()
        },
    );
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 107f32);
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 107f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 50f32);
    assert_eq!(layout.rect.left.round(), 147f32);
    assert_eq!(layout.rect.top.round(), 0f32);
    let layout = layout_tree.get_layout(node_5).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 107f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 50f32);
    assert_eq!(layout.rect.left.round(), 293f32);
    assert_eq!(layout.rect.top.round(), 0f32);
    let layout = layout_tree.get_layout(node_6).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 107f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 50f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 60f32);
