...
fn aspect_ratio5() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            size: pi_flex_layout::prelude::Size {
                width: pi_flex_layout::prelude::Dimension::Points(400f32),
                height: pi_flex_layout::prelude::Dimension::Points(400f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            flex_shrink: 1f32,
            flex_basis: pi_flex_layout::prelude::Dimension::Points(150f32),
            aspect_ratio: pi_flex_layout::prelude::Number::Defined(1.7777778f32),
            ..Default::default()
        },
    );
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            flex_shrink: 1f32,
            flex_basis: pi_flex_layout::prelude::Dimension::Points(200f32),
            aspect_ratio: pi_flex_layout::prelude::Number::Defined(1.7777778f32),
            ..Default::default()
        },
    );
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 400f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 400f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 0f32);
    let layout = layout_tree.get_layout(node_3).unwrap();
    assert_eq!((layout.rect.right - layout.rect.left).round(), 150f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 84f32);
    assert_eq!(layout.rect.left.round(), 0f32);
    assert_eq!(layout.rect.top.round(), 158f32);
    ...
    assert_eq!(layout.rect.left.round(), 150f32);
    assert_eq!(layout.rect.top.round(), 144f32);
}
