...
fn padding_relative() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            size: pi_flex_layout::prelude::Size {
                ...
                height: pi_flex_layout::prelude::Dimension::Points(300f32),
                ..Default::default()
            },
            padding: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Points(40f32),
                right: pi_flex_layout::prelude::Dimension::Points(40f32),
                top: pi_flex_layout::prelude::Dimension::Points(40f32),
                bottom: pi_flex_layout::prelude::Dimension::Points(40f32),
                ..Default::default()
            },
            border: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Points(50f32),
                right: pi_flex_layout::prelude::Dimension::Points(50f32),
                top: pi_flex_layout::prelude::Dimension::Points(50f32),
                bottom: pi_flex_layout::prelude::Dimension::Points(50f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            position: pi_flex_layout::prelude::Rect {
                left: pi_flex_layout::prelude::Dimension::Points(1f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 300f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 300f32);
    ...
    assert_eq!(layout.rect.left.round(), 41f32);
