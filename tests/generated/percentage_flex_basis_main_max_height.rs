...
fn percentage_flex_basis_main_max_height() {
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            max_size: pi_flex_layout::prelude::Size {
                height: pi_flex_layout::prelude::Dimension::Percent(0.6f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    layout_tree.insert(
        ...
        pi_flex_layout::prelude::Style {
            ...
            flex_basis: pi_flex_layout::prelude::Dimension::Percent(0.1f32),
            max_size: pi_flex_layout::prelude::Size {
                height: pi_flex_layout::prelude::Dimension::Percent(0.2f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!((layout.rect.right - layout.rect.left).round(), 148f32);
    assert_eq!((layout.rect.bottom - layout.rect.top).round(), 0f32);
    assert_eq!(layout.rect.left.round(), 52f32);
    assert_eq!(layout.rect.top.round(), 0f32);
}
